...
#ifndef PRESENTERONLINEIMPORTPREVIEW_H
...
class PresenterOnlineImportPreview : public PresenterScenePreview {
protected:
	PresenterOnlineImportPreview(const std::shared_ptr<IViewScenePreview> &pView,
								 const std::shared_ptr<IModelScenePreview> &pModel);

public:
	static std::shared_ptr<PresenterOnlineImportPreview> create(const std::shared_ptr<IViewScenePreview> &pView,
																const std::shared_ptr<IModelScenePreview> &pModel);

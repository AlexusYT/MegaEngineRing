...
sdk::utils::ReportMessagePtr ToolchainUtils::generateCMakePresetsFile(const std::filesystem::path &pPath) {
	...
	"configurePresets": [
		...
		},
		{
			...
			"hidden": true,
			"cacheVariables": {
				"CMAKE_CXX_FLAGS": "-rdynamic -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=3 -D_GLIBCXX_ASSERTIONS=1 -fstack-protector-strong -fcf-protection=full -fstack-clash-protection -Wall -Wextra -Wpedantic -Wconversion -Wsign-conversion -Wcast-qual -Wformat=2 -Wundef -Wshadow -Wcast-align -Wunused -Wnull-dereference -Wdouble-promotion -Wimplicit-fallthrough -Wextra-semi -Woverloaded-virtual -Wnon-virtual-dtor",

...
public:
	...
	virtual void addProperty(ExtensionPropertyBase* pProperty) = 0;

	virtual void removeProperty(ExtensionPropertyBase* pProperty) = 0;

	virtual void propertyChanged(ExtensionPropertyBase* pProperty) = 0;
};
} // namespace mer::sdk::main
